...
public class BoardPanel extends JPanel implements ObservadorIF {
	...
	private void SetProperties(){
		...
		this.addMouseListener(MouseListenerPanel.GetMouseListener());
	}
	...
	private void SetPaint(Graphics2D g2d, int i) {
		switch (i){
		case 0: 
			g2d.setPaint(new Color(220, 20, 60));//crimson 			(Red)
			break;
		case 1: 
			g2d.setPaint(new Color(100, 149, 237));//corn flower blue (Blue)		
			break;
		case 2: 
			g2d.setPaint(new Color(60, 179, 113));//medium sea green	(Green)		
			break;
		case 3: 
			g2d.setPaint(new Color(255, 215, 0));//gold 				(Yellow)
			break;
		}
	}	
	...
	private void SetPiecesPaint(Graphics2D g2d, int i) {
		switch (i){
		case 0: 
			g2d.setPaint(new Color(178, 34, 34));// fire brick(Red)
			break;
		case 1: 
			g2d.setPaint(new Color(65, 105, 225));//	royal blue (Blue)		
			break;
		case 2: 
			g2d.setPaint(new Color(46, 139, 87));//sea green(Green)		
			break;
		case 3: 
			g2d.setPaint(new Color(218, 165, 32));//golden rod(Yellow)
			break;
		}
	}	
