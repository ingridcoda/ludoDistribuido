...
public class ColorRules {
	...
	private static ColorRules instance = null;
	...
	int[][] getStartRed() {
		return new int [][]{ new int[]{1,4}, new int[]{4,1},	new int[]{1,1},	new int[]{4,4}};
	}

	int[][] getStartBlue() {
		return new int [][]{ new int[]{1,10}, new int[]{1,13}, new int[]{4,10}, new int[]{4,13}};
	}

	int[][] getStartGreen() {
		return new int [][]{ new int[]{10,1}, new int[]{13,1}, new int[]{10,4}, new int[]{13,4}};
	}

	int[][] getStartYellow() {
		return new int [][]{ new int[]{13,10}, new int[]{10,13}, new int[]{10,10}, new int[]{13,13}};	
	}	

	private int[] getEndRed() {
		return new int[]{6,7};
	}

	private int[] getEndBlue() {
		return new int[]{7,8};
	}

	private int[] getEndGreen() {
		return new int[]{7,6};
	}

	private int[] getEndYellow() {
		return new int[]{8,7};	
	}	

	public static ColorRules getInstance() {
		if(instance == null) {
			instance = new ColorRules();
		}
		return instance;
	}	
